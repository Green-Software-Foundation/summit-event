  ...
  plugins: [
    ...
    `gatsby-transformer-sharp`,
    {
      ...
      options: {
        ...
        short_name: `starter`,
        start_url: `/`,
        background_color: `#11283C`,
        theme_color: `#AECC53`,
        display: `minimal-ui`,
        icon: `src/images/global-summit-icon.png`, // This path is relative to the root of the site.
      },
    },
    {
    ...
    `gatsby-plugin-smoothscroll`,
    {
      ...
      options: {
        endpoint:
          "https://foundation.us5.list-manage.com/subscribe/post?u=ddc99c7db248c3df0ef4f7d24&amp;id=c5376a805c", // string; add your MC list endpoint here; see instructions below
